...
# Load the Excel file
file_path = 'C:/Users/user/OneDrive/Documents/Advanced Willy/NUFDI/NUFDI/LATimes.xlsx'  # Replace with your actual file path
...
plt.tight_layout()
plt.savefig('articles_per_month_LAT.png')
plt.show()
